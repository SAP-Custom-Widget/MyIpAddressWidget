...
`;
    class MyIpAddressWidgetBuilderPanel extends HTMLElement {
        constructor() {
            super();
    ...
    customElements.define("com-rohitchouhan-sap-myipaddresswidget-builder",
        MyIpAddressWidgetBuilderPanel
    );
})();